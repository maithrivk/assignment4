...
<center>
    ...
    <form method="post" action="#">
        <table border="0">            
            ...
            <tr>
                <td>Contact Number</td><td><input type="number" name="phone"  /></td>
            </tr>
            <tr>
                <td>Employee Category</td><td><input type="radio" name="cat" id="cat" value="part_time"  onChange="select(this.value)"/>Part Time
                    <input type="radio" name="cat"  id="cat" value="full_time"  onChange="select(this.value)" />Full Time
                    <input type="radio" name="cat"  id="cat" value="contract"   onChange="select(this.value)"/>Contract</td>
            </tr>
            <tr id="hrs" >
